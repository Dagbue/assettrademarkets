...
<!--            </a>-->
    ...
    <div class="section-1">
      ...
      <section>
        ...
        <details>
          <summary>
            How long do ATM withdrawals take via bank card?
          </summary>
          <p>
            On ATM' side all withdrawal requests are processed instantly. Your withdrawal request is then sent to
    ...
    <div class="section-1">
      ...
      <section>
        <details>
          <summary>
            Is ATM PCI DSS compliant?
          </summary>
          <p>
            ATM is independently audited and meets all PCI DSS (Payment Card Industry Data Security Standard)
        ...
        <details>
          ...
          <p>ATM accounts offer several security types to verify the identity of the account owner and protect
        ...
        <details>
          ...
          <p>
            ...
            passwords, IDs, or ATM security types. ATM reps never ask for such info via text, email, or social
            media. Don't leave your Personal Area unattended, carry out ATM activities outside the Personal Area,
            or transfer funds to unknown accounts. Beware of unknown links and don't share passwords. If you suspect
            fraud, contact ATM immediately via live chat or email. Be cautious of unexpected ATM messages; when
